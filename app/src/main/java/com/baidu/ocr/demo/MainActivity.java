...
public class MainActivity extends AppCompatActivity {
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "Qvgnm5TGRj1AnQ3IVQiRKFzK", "WUxGQCBsgGB8zTGTpmZv2BL8GrZNtP5R");
    }
    ...
    private void infoPopText(final String result) {
        alertText("", result);
        Log.i("xdb", "infoPopText: "+result);
        gson = new Gson();
        MailPostEntity mailPostEntity = gson.fromJson(result, MailPostEntity.class);
        List<MailPostEntity.WordsResultBean> words_result = mailPostEntity.getWords_result();
        alertText(words_result.get(0).getWords()+"",words_result.get(1).getWords()+"\r\n"+words_result.get(2).getWords()+"");
    }
